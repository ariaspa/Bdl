SPOOL 001_BDL_ALTER_OGGETTO_ORIGINALE.log   
...
alter table bdl_oggetto_originale add fl_doppia_pagina char(1) ;
comment on column bdl_oggetto_originale.fl_doppia_pagina is 'FLAG doppia pagina';

alter table bdl_oggetto_originale add segnatura varchar2(60) ;
comment on column bdl_oggetto_originale.segnatura is 'segnatura';
...
BDL_OGGETTO_ORIGINALE.SEGNATURA O_SEGNATURA
