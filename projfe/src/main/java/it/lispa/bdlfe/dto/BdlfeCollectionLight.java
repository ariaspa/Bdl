...
public class BdlfeCollectionLight implements Comparable<BdlfeCollectionLight> {
	
	@Override
	public int compareTo(BdlfeCollectionLight o) {
		final int BEFORE = -1;
	    final int EQUAL  =  0;
	    final int AFTER  =  1;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BdlfeCollectionLight other = (BdlfeCollectionLight) obj;
		if (area == null) {
			if (other.area != null)
				return false;
	...
	public BdlfeCollectionLight() {
	}
	
	public BdlfeCollectionLight(BigDecimal id, BdlfeRef institute, String title, BdlfeRef area, String geoCoverage,
