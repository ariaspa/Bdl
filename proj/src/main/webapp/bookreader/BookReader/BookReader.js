...
BookReader.prototype.drawLeafsOnePage = function() {
    ...
    for (i=0; i<indicesToDisplay.length; i++) {
        ...
        /* xxx: Modificato a partire da 10 */
        leafTop += height + 40;
...
BookReader.prototype.currentIndex = function() {
    ...
    if (this.mode == this.constMode1up || this.mode == this.constModeThumb) {
        ...
        // xxx: Only allow indices that are actually present in book
...
//showPopup
//______________________________________________________________________________
BookReader.prototype.showPopup = function(msg) {
  //if (soundManager.debugMode) console.log('showPopup index='+this.ttsIndex+' pos='+this.ttsPosition);
  if (this.popup) return;
...
//removePopup
//______________________________________________________________________________
BookReader.prototype.removePopup = function() {
  $(this.popup).remove();
  this.popup=null;
}
