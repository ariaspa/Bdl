...
/**
 * Interface PubblicazioneOggettiServiceAsync.
 */
public interface PubblicazioneOggettiServiceAsync {
	 ...
	 */
	void pubblicaOggetto(BigDecimal cdOggetto, AsyncCallback<Void> callback);
	 ...
	 * @param callback  callback
	 */
	void pubblicaOggetti(List<VOggettoDTO> oggetti, AsyncCallback<Void> callback);
	 ...
	 * @param callback  callback
	 */
	void diniegaOggetto(BigDecimal cdOggetto, String motivo, AsyncCallback<Void> callback);
