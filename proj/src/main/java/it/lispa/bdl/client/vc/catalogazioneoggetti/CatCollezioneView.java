...
/**
 * Class CatCollezioneView.
 */
public class CatCollezioneView extends ViewWithUiHandlers<CatCollezioneHandler> implements CatCollezioneController.iCatCollezioneView {
	 ...
	 * Interface Binder.
	 */
	public interface Binder extends UiBinder<Widget, CatCollezioneView> {
	}
    


	/**
	 * Istanzia un nuovo cat collezione view.
	 *
	 * @param eventBus  event bus
	 * @param binder  binder
	 */
	@Inject
	public CatCollezioneView(final EventBus eventBus, final Binder binder) {
    	super();
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.catalogazioneoggetti.CatCollezioneController.iCatCollezioneView#getStepLayout()
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.catalogazioneoggetti.CatCollezioneController.iCatCollezioneView#refreshFields(it.lispa.bdl.shared.dto.CollezioneDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.catalogazioneoggetti.CatCollezioneController.iCatCollezioneView#getfFieldset()
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.catalogazioneoggetti.CatCollezioneController.iCatCollezioneView#getCollezioneDTO()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.catalogazioneoggetti.CatCollezioneController.iCatCollezioneView#activateModifyForm()
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.catalogazioneoggetti.CatCollezioneController.iCatCollezioneView#activateView()
	 */
