...
/**
 * Class ValOggettoAnteprimaImmagineView.
 */
public class ValOggettoAnteprimaImmagineView extends
GXTPopupViewWithUiHandlers<ValOggettoAnteprimaImmagineHandler> implements
ValOggettoAnteprimaImmagineController.iValOggettoAnteprimaImmagineView {
	 ...
	 * Interface Binder.
	 */
	public interface Binder extends UiBinder<Widget, ValOggettoAnteprimaImmagineView> {
	}
	...
	/**
	 * Istanzia un nuovo val oggetto anteprima immagine view.
	 *
	 ...
	 */
	@Inject
	public ValOggettoAnteprimaImmagineView(final EventBus eventBus, final Binder binder,ValOggettoAnteprimaImmagineMsg messages, Images img) {
		super(eventBus);
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.validazioneoggetti.ValOggettoAnteprimaImmagineController.iValOggettoAnteprimaImmagineView#resetImage(it.lispa.bdl.shared.dto.ImmagineDTO)
	 */
