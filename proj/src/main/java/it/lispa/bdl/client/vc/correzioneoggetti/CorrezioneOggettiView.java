...
/**
 * Class CorrezioneOggettiView.
 */
public class CorrezioneOggettiView extends ViewWithUiHandlers<CorrezioneOggettiHandler> implements CorrezioneOggettiController.iCorrezioneOggettiView {
	 ...
	 * Interface Binder.
	 */
	public interface Binder extends UiBinder<Widget, CorrezioneOggettiView> {
	...
	/**
	 * Istanzia un nuovo correzione oggetti view.
	 *
	 * @param binder  binder
	 * @param img  img
	 ...
	 */
	@Inject
	public CorrezioneOggettiView(final Binder binder, Images img, CorrezioneOggettiMsg messages) {
		...
		filtriFlag.put(BdlSharedConstants.VOGGETTI_FILTRO_FL_OGGETTO_DIGITALE, new Boolean(true));
		filtriFlag.put(BdlSharedConstants.VOGGETTI_FILTRO_FL_CORREZIONE, new Boolean(true));
		...
		ColumnConfig<VOggettoDTO, String> col7 = new ColumnConfig<VOggettoDTO, String>(gridProps.O_FlAnomaliaImmagini_Human(), 80, messages.anomalia());
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.correzioneoggetti.CorrezioneOggettiController.iCorrezioneOggettiView#loadGridData()
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.correzioneoggetti.CorrezioneOggettiController.iCorrezioneOggettiView#loadTreeData()
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.correzioneoggetti.CorrezioneOggettiController.iCorrezioneOggettiView#getGrid()
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.correzioneoggetti.CorrezioneOggettiController.iCorrezioneOggettiView#getPanel()
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.correzioneoggetti.CorrezioneOggettiController.iCorrezioneOggettiView#getTree()
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.correzioneoggetti.CorrezioneOggettiController.iCorrezioneOggettiView#getTreeStore()
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.correzioneoggetti.CorrezioneOggettiController.iCorrezioneOggettiView#setTreeItem(it.lispa.bdl.shared.dto.SubMenuItemDTO)
	 */
