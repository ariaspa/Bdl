...
/**
 * Class PubOggettoListaView.
 */
public class PubOggettoListaView extends ViewWithUiHandlers<PubOggettoListaHandler> implements PubOggettoListaController.iPubOggettoListaView {
	 ...
	 * Interface Binder.
	 */
	public interface Binder extends UiBinder<Widget, PubOggettoListaView> {
	...
	@UiField TextButton lPubblica;

	/**
	 * Istanzia un nuovo pub oggetto lista view.
	 *
	 * @param binder  binder
	 * @param img  img
	 ...
	 */
	@Inject
	public PubOggettoListaView(final Binder binder, Images img, ValOggettoListaMsg messages) {
		...
		com.sencha.gxt.data.shared.loader.DataProxy<FilterPagingLoadConfig, PagingLoadResult<VOggettoDTO>> dataProxy = new com.sencha.gxt.data.shared.loader.DataProxy<FilterPagingLoadConfig,PagingLoadResult<VOggettoDTO>>() {
			...
			public void load(
				...
				callback.onSuccess(
						it.lispa.bdl.client.mockservice.Mock.ValOggettoListaViewGrid(loadConfig)
						);
		...
		grid.getSelectionModel().addSelectionChangedHandler(new SelectionChangedHandler<VOggettoDTO>() {
			...
			public void onSelectionChanged(SelectionChangedEvent<VOggettoDTO> event) {
				...
				if(size > 1){
					...
					lPubblica.setEnabled(true);
				}else if(size == 1){
					lVisualizza.setEnabled(true);
					lPubblica.setEnabled(true);
				}else{
					lVisualizza.setEnabled(false);
					lPubblica.setEnabled(false);
				}
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.pubblicazioneoggetti.PubOggettoListaController.iPubOggettoListaView#loadGridData()
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.pubblicazioneoggetti.PubOggettoListaController.iPubOggettoListaView#getGrid()
	 */
	 ...
	 */
	@UiHandler("lPubblica")
	public void onLValida(SelectEvent event) {
		if (getUiHandlers() != null) {
			getUiHandlers().onLPubblica();
		}
	}

	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.pubblicazioneoggetti.PubOggettoListaController.iPubOggettoListaView#setCdIstituto(java.math.BigDecimal)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.pubblicazioneoggetti.PubOggettoListaController.iPubOggettoListaView#setCdProgetto(java.math.BigDecimal)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.pubblicazioneoggetti.PubOggettoListaController.iPubOggettoListaView#setCdCollezione(java.math.BigDecimal)
	 */
	@Override
