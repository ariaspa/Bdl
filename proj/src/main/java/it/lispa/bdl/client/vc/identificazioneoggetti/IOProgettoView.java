...
/**
 * Class IOProgettoView.
 */
public class IOProgettoView extends ViewWithUiHandlers<IOProgettoHandler> implements IOProgettoController.iIOProgettoView {
	 ...
	 * Interface Binder.
	 */
	public interface Binder extends UiBinder<Widget, IOProgettoView> {
	}
    


	/**
	 * Istanzia un nuovo IO progetto view.
	 *
	 * @param eventBus  event bus
	 * @param binder  binder
	 */
	@Inject
	public IOProgettoView(final EventBus eventBus, final Binder binder) {
    	super();
        ...
        fTitoloBreve.addValidator(new MaxLengthValidator(50));
	 ...
	 * @param event  event
	 */
	@UiHandler("vCollezione")
	public void onVCollezione(SelectEvent event) {
		if (getUiHandlers() != null) {
			getUiHandlers().onVCollezione();
		}
	}
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.identificazioneoggetti.IOProgettoController.iIOProgettoView#getStepLayout()
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.identificazioneoggetti.IOProgettoController.iIOProgettoView#refreshFields(it.lispa.bdl.shared.dto.ProgettoDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.identificazioneoggetti.IOProgettoController.iIOProgettoView#getfFieldset()
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.identificazioneoggetti.IOProgettoController.iIOProgettoView#getProgettoDTO()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.identificazioneoggetti.IOProgettoController.iIOProgettoView#activateInsertForm()
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.identificazioneoggetti.IOProgettoController.iIOProgettoView#activateModifyForm()
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.identificazioneoggetti.IOProgettoController.iIOProgettoView#activateView()
	 */
