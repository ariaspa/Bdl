...
/**
 * Class ValOggettoDettaglioView.
 */
public class ValOggettoDettaglioView extends ViewWithUiHandlers<ValOggettoDettaglioHandler> implements ValOggettoDettaglioController.iValOggettoDettaglioView {
	...
	@UiField FieldSet fieldsetValidazione;
	@UiField VerticalLayoutContainer fieldsetVlcValidazione;
	...
	ValOggettoDettaglioMsg messages;
	 ...
	 * Interface Binder.
	 */
	public interface Binder extends UiBinder<Widget, ValOggettoDettaglioView> {
	}

	/**
	 * Istanzia un nuovo val oggetto dettaglio view.
	 *
	 ...
	 */
	@Inject
	public ValOggettoDettaglioView(final EventBus eventBus, final Binder binder, ValOggettoDettaglioMsg myMessages, Images img) {
	...
	public void setImageSommario(BigDecimal cdOggetto,String nomeImmagine){
		...
		servizioValidazione.getImmagineReader(cdOggetto,nomeImmagine,new AsyncCallback<ImmagineDTO>() {
	...
	public void onBtnDiniega(SelectEvent event) {
		if (getUiHandlers() != null) {
			getUiHandlers().onBtnDiniega(noteDiniegoValidazione.getCurrentValue());
		}
	}
	 ...
	 */
	@UiHandler("btnValida")
	public void onBtnValida(SelectEvent event) {
		if (getUiHandlers() != null) {
			getUiHandlers().onBtnValida();
		}
	}
	...
	public void refreshData(final OggettoDTO item, final String naturaOggettoOriginale) {
		...
		noteDiniegoValidazione.setText(item.getNoteNonValidazione());
		...
		servizioValidazione.getCronologia(item.getCdOggettoOriginale(),new AsyncCallback<List<CronologiaDTO>>() {
			public void onFailure(Throwable caught) {
				// non faccio nulla, errore gestito a monte
			}
			@Override
		...
		servizioValidazione.getTocSommarioOggetto(item.getCdOggettoOriginale(),new AsyncCallback<List<TocSommarioDTO>>() {
			public void onFailure(Throwable caught) {
				// non faccio nulla, errore gestito a monte
			}
			@Override
		...
		servizioValidazione.getImmaginiOggetto(item.getCdOggettoOriginale(),new AsyncCallback<List<ImmagineDTO>>() {
			public void onFailure(Throwable caught) {
				// non faccio nulla, errore gestito a monte
			}
			@Override
	...
	private void forceLayoutElements(){
		buttonsValidazione.forceLayout();
		fieldsetValidazione.forceLayout();
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.validazioneoggetti.ValOggettoDettaglioController.iValOggettoDettaglioView#activateValidazione(it.lispa.bdl.shared.dto.OggettoDTO, java.lang.String)
	 */
	@Override
	public void activateValidazione(OggettoDTO item, String naturaOggettoOriginale) {
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.validazioneoggetti.ValOggettoDettaglioController.iValOggettoDettaglioView#activateCatalogazioneView(it.lispa.bdl.shared.dto.OggettoDTO, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.validazioneoggetti.ValOggettoDettaglioController.iValOggettoDettaglioView#activateCronologia(it.lispa.bdl.shared.dto.OggettoDTO, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.validazioneoggetti.ValOggettoDettaglioController.iValOggettoDettaglioView#activateSommario(it.lispa.bdl.shared.dto.OggettoDTO, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.validazioneoggetti.ValOggettoDettaglioController.iValOggettoDettaglioView#activateAnteprima(it.lispa.bdl.shared.dto.OggettoDTO, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.validazioneoggetti.ValOggettoDettaglioController.iValOggettoDettaglioView#activateCorrezioni(it.lispa.bdl.shared.dto.OggettoDTO, java.lang.String)
	 */
	@Override
