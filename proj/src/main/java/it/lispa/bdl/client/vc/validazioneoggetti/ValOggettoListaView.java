...
/**
 * Class ValOggettoListaView.
 */
public class ValOggettoListaView extends ViewWithUiHandlers<ValOggettoListaHandler> implements ValOggettoListaController.iValOggettoListaView {
	 ...
	 * Interface Binder.
	 */
	public interface Binder extends UiBinder<Widget, ValOggettoListaView> {
	...
	@UiField TextButton lValida;

	/**
	 * Istanzia un nuovo val oggetto lista view.
	 *
	 * @param binder  binder
	 * @param img  img
	 ...
	 */
	@Inject
	public ValOggettoListaView(final Binder binder, Images img, ValOggettoListaMsg messages) {
		...
		grid.getSelectionModel().addSelectionChangedHandler(new SelectionChangedHandler<VOggettoDTO>() {
			...
			public void onSelectionChanged(SelectionChangedEvent<VOggettoDTO> event) {
				...
				if(size > 1){
					...
					lValida.setEnabled(true);
				}else if(size == 1){
					lVisualizza.setEnabled(true);
					lValida.setEnabled(true);
				}else{
					lVisualizza.setEnabled(false);
					lValida.setEnabled(false);
				}
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.validazioneoggetti.ValOggettoListaController.iValOggettoListaView#loadGridData()
	 */
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.validazioneoggetti.ValOggettoListaController.iValOggettoListaView#getGrid()
	 */
	...
	public void onLValida(SelectEvent event) {
		if (getUiHandlers() != null) {
			getUiHandlers().onLValida();
		}
	}

	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.validazioneoggetti.ValOggettoListaController.iValOggettoListaView#setCdIstituto(java.math.BigDecimal)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.validazioneoggetti.ValOggettoListaController.iValOggettoListaView#setCdProgetto(java.math.BigDecimal)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.lispa.bdl.client.vc.validazioneoggetti.ValOggettoListaController.iValOggettoListaView#setCdCollezione(java.math.BigDecimal)
	 */
	@Override
