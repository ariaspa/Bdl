...
public abstract class GXTPopupViewImpl extends ViewImpl implements PopupView {
	...
	/* (non-Javadoc)
	 * @see com.gwtplatform.mvp.client.PopupView#center()
	 */
	public void center() {
		asPopupPanel().forceLayout();
		doCenter();
	...
	/* (non-Javadoc)
	 * @see com.gwtplatform.mvp.client.PopupView#hide()
	 */
	public void hide() {
		asPopupPanel().hide();
	}
	...
	/* (non-Javadoc)
	 * @see com.gwtplatform.mvp.client.PopupView#setAutoHideOnNavigationEventEnabled(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see com.gwtplatform.mvp.client.PopupView#setCloseHandler(com.gwtplatform.mvp.client.PopupViewCloseHandler)
	 */
	...
	/* (non-Javadoc)
	 * @see com.gwtplatform.mvp.client.PopupView#setPosition(int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see com.gwtplatform.mvp.client.PopupView#show()
	 */
	public void show() {
		asPopupPanel().show();
	}
